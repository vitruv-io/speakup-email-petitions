...
delete_option( 'dk_speakup_options' );
delete_option( 'dk_speakup_version' );
...
foreach ( $petitions as $petition ) {
	...
	$transient_petition = 'dk_speakup_petition_' . $petition->id;
	$transient_signatureslist = 'dk_speakup_signatureslist_' . $petition->id;
	$transient_signatures_total = 'dk_speakup_signatures_total_' . $petition->id;
...
// delete widget data
$sql_widget = "DELETE FROM $db_options WHERE option_name = 'widget_dk_speakup_petition_widget'";
